...
RUN curl -SLO https://cpan.metacpan.org/authors/id/S/SH/SHAY/perl-5.26.1.tar.bz2 \
    && echo 'fadec45b7b48a06b3d2adab91c13f568dce717cd *perl-5.26.1.tar.bz2' | sha1sum -c - \
