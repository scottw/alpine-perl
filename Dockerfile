...
RUN curl -SLO https://cpan.metacpan.org/authors/id/X/XS/XSAWYERX/perl-5.26.0.tar.bz2 \
    && echo '2ca1b28f2c3ed4cc3b74be89d150ed0377f0336a *perl-5.26.0.tar.bz2' | sha1sum -c - \
